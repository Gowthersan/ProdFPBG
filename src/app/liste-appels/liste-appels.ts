...
const AAP_CARDS: AAPCard[] = [
  {
    ...
    resume:
      `Appel visant des projets locaux de protection, restauration, sensibilisation et gestion durable des écosystèmes marins et littoraux au Gabon.`,
...
@Component({
  ...
  standalone: true,
  imports: [NgFor, NgIf, RouterLink, DatePipe, CurrencyPipe],
